...
/**
 * ينشئ كشف حساب PDF بعرض HTML حقيقي (يدعم العربية بشكل كامل وصحيح)،
    ...
    .map((item, i) => {
      ...
      return `
        <tr style="background:${bg}">
          ...
          <td style="padding:8px 10px;text-align:right;font-size:11px;color:${TEXT}">${item.description || ""}</td>
